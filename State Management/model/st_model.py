...
def make_pred(model):
    ...
    X = [[miles,year,make,model_key,engine_size,province]]
...
if __name__ == "__main__":
    ...
    with st.form(key='form'):
        ...
        with col1:
            ...
            st.selectbox("Model", index=0, key="model",
                         options=['Prius', 'Highlander', 'Civic', 'Accord', 'Corolla', 'Ridgeline',
        ...
        st.form_submit_button('Calculate',type='primary',on_click=model_make)

    st.write('The estimated car price is')
